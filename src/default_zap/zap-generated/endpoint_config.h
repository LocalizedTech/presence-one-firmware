...
#define GENERATED_MIN_MAX_DEFAULTS                                             \
  {                                                                            \
    ...
    {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0xFFFF}, /* HoldTime */           \
        ...
        {(uint16_t)0xF, (uint16_t)0x1, (uint16_t)0xFE}, /* OnLevel */          \
                                                                               \
        /* Endpoint: 4, Cluster: Level Control (server) */                     \
        {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x3},   /* Options */         \
        {(uint16_t)0x64, (uint16_t)0x1, (uint16_t)0xFE}, /* OnLevel */         \
                                                                               \
        /* Endpoint: 5, Cluster: Level Control (server) */                     \
        {(uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x3}, /* Options */           \
    {                                                                          \
      (uint16_t)0x64, (uint16_t)0x1, (uint16_t)0xFE                            \
    } /* OnLevel */                                                            \
  }
    ...
    {ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                      \
     ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
        ...
        {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */              \
                                                                               \
        /* Endpoint: 2, Cluster: Level Control (server) */                     \
        {ZAP_SIMPLE_DEFAULT(0xFF), 0x00000000, 1, ZAP_TYPE(INT8U),             \
         ZAP_ATTRIBUTE_MASK(READABLE) |                                        \
        ...
        {ZAP_MIN_MAX_DEFAULTS_INDEX(3), 0x0000000F, 1, ZAP_TYPE(BITMAP8),      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* Options */                      \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(4), 0x00000011, 1, ZAP_TYPE(INT8U),        \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) |          \
             ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |     \
             ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* OnLevel */                      \
        {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),             \
        ...
        {ZAP_SIMPLE_DEFAULT(0xFF), 0x00000000, 1, ZAP_TYPE(INT8U),             \
         ZAP_ATTRIBUTE_MASK(READABLE) |                                        \
             ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* CurrentLevel */                 \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(5), 0x0000000F, 1, ZAP_TYPE(BITMAP8),      \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |          \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* Options */                      \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(6), 0x00000011, 1, ZAP_TYPE(INT8U),        \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) |          \
             ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |     \
             ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* OnLevel */                      \
        {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),             \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
    {ZAP_CLUSTER_INDEX(0), 12, 84}, {ZAP_CLUSTER_INDEX(12), 4, 3},             \
        {ZAP_CLUSTER_INDEX(16), 3, 9}, {ZAP_CLUSTER_INDEX(19), 3, 7},          \
        {ZAP_CLUSTER_INDEX(22), 3, 9}, {ZAP_CLUSTER_INDEX(25), 3, 9},          \
  }
...
#define FIXED_DEVICE_TYPES                                                     \
  {                                                                            \
    {0x00000012, 1}, {0x00000016, 4}, {0x00000107, 1}, {0x0000000E, 1},        \
        {0x0000000E, 1}, {0x0000000E, 1}, {                                    \
      0x0000000E, 1                                                            \
    }                                                                          \
  }
